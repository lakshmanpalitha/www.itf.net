...
class Mdlext_Mdloption_Model_Config_Homepage 
{
    ...
    {
        return array(
            array('value' => '1', 'label'=>Mage::helper('adminhtml')->__('Banner with 3 right static blocks')),
			...
			array('value' => '4', 'label'=>Mage::helper('adminhtml')->__('Banner with 2 right static blocks')),
        );
    }
}
?>